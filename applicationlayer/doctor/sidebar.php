				...
				<!--APP-SIDEBAR-->
					...
					<aside class="app-sidebar">
						<div class="side-header">
							<a class="header-brand1" href="homedoctor.php">
								<br>
							<h1 class="page-title">Welcome to Doctor Page</h1>
								<!-- <img src="DentalClinicLogo.png" class="header-brand-img light-logo1" alt="logo"> -->
							</a><!-- LOGO -->
						</div>
						<style>
                           .side-menu_space {
						...
						<ul class="side-menu">
						<li class="slide">
								<a class="side-menu__item" href="homedoctor.php">
							...
							<li class="slide">
								<a class="side-menu__item" href="schedule.php">
									<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
							...
							<li class="slide">
								<a class="side-menu__item" href="appointment.php">
									<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
							...
							<li class="slide">
								<a class="side-menu__item" href="patient.php">
									<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
							...
							<li class="slide">
								<a class="side-menu__item" href="viewfeedback.php">
									<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
