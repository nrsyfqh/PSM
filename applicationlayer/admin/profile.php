<?php 
    ...
    $stmt = $mysqli->prepare("SELECT * FROM admin WHERE username = ? AND Status = 'Active'");
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form action="../../datalayer/profileUpdate.php" method="post" >
                                            <table class="table table-user-information">
                                                <tbody>
                                                        <input type="text" style = "display: none" name="adminId" id="update_id" value ="<?php echo $row['adminId'] ?>">
                                                    <tr>
                                                        <td>Phone</td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <button type="submit" name="updatedataAdmin" class="btn btn-info">Update Info</td>
                                                        </tr>
                                                    </tbody>
