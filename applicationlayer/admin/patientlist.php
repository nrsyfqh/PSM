													...
													<tbody>
														...
														<?php while ($row = mysqli_fetch_assoc($results)) { ?>
															<tr>
																...
																<td>
																	<a href="../../datalayer/patientDelete.php?delete=<?php echo $row['patientId']; ?>" class="btn btn-default btn-sm mb-2 mb-xl-0" data-toggle="tooltip" data-original-title="Delete">
																		<i class="fa fa-trash"></i>
																	</a>
																	<a href="../../datalayer/patientDelete.php?active=<?php echo $row['patientId']; ?>" class="btn btn-default btn-sm mb-2 mb-xl-0" data-toggle="tooltip" data-original-title="Active">
																		<i class="fa fa-check"></i>
																	</a>                                                  
																	<a href="javascript:UpdateEdit(<?php echo $row['patientId']; ?>)" class="btn btn-default btn-sm mb-2 mb-xl-0 editbtn" data-toggle="tooltip" data-original-title="Edit">     
																		<i class="fa fa-pencil" id="editbtn"></i>   
																	</a>
																	<a href="patientdetails.php?patientId=<?php echo $row['patientId']; ?>" class="btn btn-default btn-sm mb-2 mb-xl-0 viewbtn" data-toggle="tooltip" data-original-title="View">     
