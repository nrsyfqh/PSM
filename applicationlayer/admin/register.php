	...
	<div class="page">		
		...
		<?php include 'sidebar.php' ?>
			...
			<div class="app-content">
				<div class="side-app"></div>

				    <!-- CONTAINER OPEN -->
					
					<div class="container-login100">
						<div class="wrap-login100 p-6">
							<form class="login100-form validate-form" action = "../../datalayer/doctor.php" method="POST" >
								<span class="login100-form-title">
									Registration Doctor
								</span>
									<!-- IC Number -->
									<div class="wrap-input100 validate-input">
										<input class="input100" type="text" name="doctorId" placeholder="IC Number" required >
								...
								<div class="container-login100-form-btn">
									<a href="doclist.php"  class="login100-form-btn btn-danger" value="Cancel" name="cancel">Cancel</a>	
								</div>
			...
			<script>
				function validateICNumber() {
					var icNumber = document.getElementsByName('doctorId')[0].value;
