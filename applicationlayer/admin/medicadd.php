	...
	<body class="app sidebar-mini">
			...
			<div class="page-main">
				...
				<div class="app-content">
					<div class="side-app">
						...
						<!-- ROW-1 OPEN -->
						<form id="postForm" action="../../datalayer/medication.php" method="POST">
							<div class="row">
											...
											<div class="table-responsive">
												<div class="col-md-6">
													<div class="form-group">
														...
														<label class="form-label">Name medication</label>
													...
													<div class="form-group">
														<label class="form-label">Usage Guideline</label>
														<input type="text" class="form-control" id="guideline" name="guideline" placeholder="Guideline">
													</div>

													<div class="btn-list">
														<button class="btn btn-primary" name="submit" type="submit">Submit</button>
														<a href="mediclist.php" class="btn btn-danger" name="cancel">Cancel</a>
													</div>
												</div>
											</div>
										</div>
		...
		<script>
			document.addEventListener('DOMContentLoaded', function () {
				...
				var dropdownOptions = document.querySelectorAll('.btn-group .dropdown-menu a');
				...
				dropdownOptions.forEach(function (option) {
					option.addEventListener('click', function (event) {
						...
						dropdownButton.innerHTML = event.target.innerHTML + " <span class='caret'></span>";

						// Set the selected adminId as a value in a hidden input field
						adminIdInput.value = event.target.dataset.adminid;
					});
				});

				// Add form submission validation
				document.querySelector('#postForm').addEventListener('submit', function (event) {
					if (!nameInput.value || !descriptionInput.value || !guidelineInput.value || !adminIdInput.value) {
