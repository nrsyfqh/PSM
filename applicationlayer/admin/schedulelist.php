												...
												<tbody>
                                                    <?php 
                                                        ...
                                                        if ($_SERVER["REQUEST_METHOD"] == "POST") {
                                                            ...
                                                            if (!preg_match("/^\d{4}-\d{2}-\d{2}$/", $searchDate)) {
                                                                ...
                                                                WHERE (sch.avail  = 'Available' OR sch.avail  = 'Unavailable') AND sch.date = '$searchDate'
                                                                ORDER BY sch.date DESC, sch.startTime ASC");
                                                                ...
                                                                $results = mysqli_query($mysqli, "SELECT sch.scheduleId, doctor.name, sch.date, sch.day, sch.startTime, sch.endTime, sch.avail 
                                                                    FROM doctor 
                                                                    JOIN schedule AS sch ON doctor.doctorId = sch.doctorId
                                                                    WHERE (sch.avail  = 'Available' OR sch.avail  = 'Unavailable') AND sch.date = '$currentDate'
                                                                    ORDER BY sch.date DESC, sch.startTime ASC");
                                                            }
                                                        ?>
                                                    <?php while ($row=mysqli_fetch_assoc($results)){ ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                            <a href="../../datalayer/scheduleDelete.php?delete=<?php echo $row['scheduleId']; ?>"class="btn btn-default btn-sm mb-2 mb-xl-0" data-toggle="tooltip" data-original-title="Delete">
                                                                <i class="fa fa-trash"></i></a>
                                                            <a href="../../datalayer/scheduleDelete.php?active=<?php echo $row['scheduleId']; ?>"class="btn btn-default btn-sm mb-2 mb-xl-0" data-toggle="tooltip" data-original-title="Active">
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <!-- Form start -->
                                        <form action="../../datalayer/schedule.php" method="post" class="needs-validation" novalidate onsubmit="return validateForm();">
								...
								<div class="modal-content">
									...
									<form action="../../datalayer/scheduleUpdate.php" method="POST">
										...
										<div class="modal-footer">
											...
											<button type="submit" name="schUpdate" class="btn btn-primary">Update Data</button>
										</div>
									</form>
